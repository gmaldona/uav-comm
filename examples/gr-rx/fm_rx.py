...
class fm_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tuner = tuner = int(9.28e7)
        self.samp_rate = samp_rate = 2e6
        self.down_rate = down_rate = 2.5e5
        ...
        _tuner_dial_control = qtgui.GrDialControl('', self, int(9.00e7),int(1.05e8),int(9.28e7),"teal",self.set_tuner,isFloat, scaleFactor, 100, False, "'value'")
        self.tuner = _tuner_dial_control

        self.top_layout.addWidget(_tuner_dial_control)
        ...
        self.soapy_bladerf_source_0.set_frequency(0, tuner)
    ...
    def set_tuner(self, tuner):
        self.tuner = tuner
        self.soapy_bladerf_source_0.set_frequency(0, self.tuner)
